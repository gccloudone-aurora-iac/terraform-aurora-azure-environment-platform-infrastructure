...
| 2026-07-07 | v3.2.1  | Federated Identity Credential for Thanos Compactor and Store gateway        |
| 2026-07-08 | v3.2.2  | Set default action from allow to deny for network rules on storage accounts |